...
<body>
    ...
    <div class="corpo-categorias">
        ...
        <div class="linha linha2">
            <h2 class="titulo-bolsas">Bolsas</h2>
        ...
        <div class="linha">
            ...
            <div class="col-4">
                ...
                <p>R$ 46,00</p>
                <br>
                <button class="btn-adicionar" onclick="adicionarAoCarrinho('Ecobag Estampada em Tons de Azul', 46.00)">Adicionar ao Carrinho</button>
            ...
            <div class="col-4">
                ...
                <h4>Ecobag com Estampa Floral</h4><br>
                <div class="classificacao">
                    <ion-icon name="star"></ion-icon>
                    <ion-icon name="star"></ion-icon>
                    <ion-icon name="star"></ion-icon>
            ...
            <!-- FIM ITEM PRODUTO-->
            <div class="col-4">
                <img src="assets/img/bolsa-colorida-frente.jpg" alt="">
                <br>
                ...
                <p>R$ 38,99</p>
                <br>
                <button class="btn-adicionar" onclick="adicionarAoCarrinho(' Ecobag Primavera Florida', 38.99 )">Adicionar ao Carrinho</button>
